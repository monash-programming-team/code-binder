...
%%%         You will also need to have the python script 'pygments' installed
%%%         for syntax colouring. The pygments style 'style.py' will need to be
%%%         symlinked from your pygments style directory called monash.py. This
%%%			can be done using the setup script "setup.sh"
%%%
...
\fancyhead[CE,CO]{\bfseries Team Reference Document}
...
\usemintedstyle{monash}

% Including code
% \algo includes the algorithm in the table of contents
% \algo* omits the entry from the table of contents.
\newcommand{\mintedrange}[2]{
	\immediate\write18{python3 minted_delim.py "#1" "//listings:#2" "//listings:/#2"}%
	\inputminted[
		fontsize=\scriptsize,
		tabsize=2
	]{cpp_lexer.py:CppLexerMod -x}{snippet.tmp} % Spooky hack to use custom lexer
}
...
\algo*{"../official/number-theory/number-theory.cpp"}{int128}{128-bit Integer}

%%% Tested
\algo*{"../official/number-theory/number-theory.cpp"}{expmod}{Binary Exponentiation}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{euclidean}{Extended Euclidean Algorithm}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{inverse}{Modular Multiplicative Inverse}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{cra}{Chinese Remainder Algorithm}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{phi}{Euler's Totient Function}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{sieve}{Sieve of Eratosthenes}

%%% Tested
\algo*{"../official/number-theory/number-theory.cpp"}{mr_seeds}{Millar-Rabin}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{prime_test}{Primality Testing}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{factorise}{Prime Factorisation}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{primitive_root}{Primitive Roots}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{discrete_root}{Discrete Roots}

%%% Tested
\algo{"../official/number-theory/number-theory.cpp"}{discrete_log}{Discrete Logarithm}

%%% Fully tested reliability 5
\algo{"../official/number-theory/ntt.cpp"}{ntt}{Fast Convolution using Number Theoretic Transform}
