# -*- coding: utf-8 -*-
#
# C++ lexer modification: Changed 'auto' from a keyword to a type
# so that it will get syntax coloured like a type.
#
"""
...
class CFamilyLexerMod(RegexLexer):
    """
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'[~!%^&*+=|?:<>/-]', Operator),
            (r'[()\[\],.]', Punctuation),
            (words(('break', 'case', 'const', 'continue', 'default', 'do',
                    'else', 'enum', 'extern', 'for', 'goto', 'if', 'register',
                    'restricted', 'return', 'sizeof', 'static', 'struct',
                    'switch', 'typedef', 'union', 'volatile', 'while'),
                   suffix=r'\b'), Keyword),
            (r'(auto|bool|int|long|float|short|double|char|unsigned|signed|void)\b',
             Keyword.Type),
...
class CppLexerMod(CFamilyLexerMod):
    """
